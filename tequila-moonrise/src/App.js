...
import HotelReserve from './pages/Pages/HotelReserve';
import HotelReserveRoom from './pages/Pages/HotelReserveRoom';
import GuestInformation from './pages/Pages/GuestInformation';
import BookingConfirmation from './pages/Pages/BookingConfirmation';
import Restaurant from './pages/Pages/Restaurant';
import Stay from './pages/Pages/Stay';
